...
class DwDenseUNet:
    def __init__(self,
        ...
        self.dense_block_size = dense_block_size #[10, 15, 20]  # arbitrary size
    ...
    def build(self):
        ...
        for i in range(self.dense_block_size):
            # DB: Depth-wise separable Dense-Block
            l = self.depthwise_block(stackBtN, self.dense_filter_size)
        ...
        # ====================================== DECODER =======================================
        # Block 4u
        convB4u = Conv2DTranspose(258, (2, 2), strides=(2, 2), padding='same')(stackBtN)
