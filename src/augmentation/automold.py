'''
Automold is a powerful library to generate various type of transformation
which reflect the real-world environment conditions.

credit: https://github.com/UjjwalSaxena/Automold--Road-Augmentation-Library
'''
# import glob
import cv2 as cv2
import numpy as np
